...
@implementation EYQRCodePreView

- (instancetype)initWithFrame:(CGRect)frame {
    
    return [[EYQRCodePreView alloc] initWithFrame:frame rectFrame:CGRectZero rectColor:[UIColor clearColor]];
}

- (instancetype)initWithFrame:(CGRect)frame rectColor:(UIColor *)rectColor {
    
    return [[EYQRCodePreView alloc] initWithFrame:frame rectFrame:CGRectZero rectColor:rectColor];
}

- (instancetype)initWithFrame:(CGRect)frame rectFrame:(CGRect)rectFrame {
    
    return [[EYQRCodePreView alloc] initWithFrame:frame rectFrame:rectFrame rectColor:[UIColor clearColor]];
}
...
- (instancetype)initWithFrame:(CGRect)frame rectFrame:(CGRect)rectFrame rectColor:(UIColor *)rectColor {
    ...
    if (self) {
        ...
        [_torchSwithButton setImage:[UIImage imageNamed:@"ey_torch_switch_off"] forState:UIControlStateNormal];
        [_torchSwithButton setImage:[[UIImage imageNamed:@"ey_torch_switch_on"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateSelected];
